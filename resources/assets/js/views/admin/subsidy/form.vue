                ...
                <div class="bs-component">
                    <form @submit.prevent="submitClicked">
                        <fieldset>
                            ...
                            【非アクティブ化する】
                            <div class="row">
                                <toggle-button v-model="subsidy.deactivate" :value="false" :color="color" :sync="true" :labels="{checked: '真実', unchecked: '偽'}" />
                            </div>
                             <div class="form-group">
    ...
    export default {
        ...
        created() {
            if (this.$route.params.model)
                this.editSubsidy(this.$route.params.model)
        },
