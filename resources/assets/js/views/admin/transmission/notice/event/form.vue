                    ...
                    <form action="" method="post">
                        <fieldset>
                            ...
                            <div class="col-lg-12 form-group">
                                ...
                                <input v-model="event.url" class="form-control" id="linkname" type="text" v-validate="'url:{require_protocol?}'" name="url"
                                    data-vv-as="関連URL">
                            ...
                            <div class="col-lg-12 form-group">
                                ...
                                <div class="form-group row">
                                    <toggle-button v-model="event.deactivate" :width="60" :value="true" :color="switchColorDeactivate" :sync="true" :labels="{ checked: '非公開', unchecked: '公開' }"
                                    />
                                </div>
                            </div>
                        </fieldset>
