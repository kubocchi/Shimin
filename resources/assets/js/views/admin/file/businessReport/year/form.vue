                    ...
                    <form @submit.prevent="confirm">
                        <fieldset>
                            <div class="col-lg-12 form-group">
                                ...
                                <input class="form-control" v-model="year.year" placeholder="年度" id="subject" v-validate="'required'" name="year" data-vv-as="件名"
                                    type="text">
    ...
    export default {
        ...
        methods: {
            ...
            fillFormWithRecievedModel(year) {
                ...
                // For Files
                if (year.file) this.currentAddedFileIs = year.file.split(",");
            },
            ...
            confirm() {
                this.$validator.validate().then(result => {
                    if (!result) {
                        ...
                        this.year.start_date = !!this.range
                            ? this.range[0].toISOString().slice(0, 10)
                            : "";
                        this.year.end_date = !!this.range
