            ...
            <div class="col-lg-12">
                ...
                <div class="row mt-4">
                    ...
                    <div class="form-group col-md-4 offset-sm-6">
                        <div class="input-group">
                            <input type="text" v-model="params.search" class="form-control" @keyup.enter="fetchDream()">
                            <span class="input-group-btn">
                                <button class="btn btn-outline-primary" @click.prevent="fetchDream()">
                    ...
                    <table class="table table-sm">
                        ...
                        <tbody>
                            <tr v-for="(dream, rowNumber) in dreams" v-bind:key="dream.id">
                                ...
                                <td>
                                    <a class="btn btn-outline-danger btn-block" @click.prevent="deletedream(dream.id)" role="button">削除</a>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                ...
                <ul class="pagination justify-content-end">
                    <li v-bind:class="[{disabled: !pagination.prev_page_url}]" class="page-item">
                        <button class="page-link" href="#!" @click.prevent="fetchDream(pagination.prev_page_url)">前へ</button>
                    </li>
                    ...
                    <li v-bind:class="[{disabled: !pagination.next_page_url}]" class="page-item">
                        <button class="page-link" href="#!" @click.prevent="fetchDream(pagination.next_page_url)">次へ</button>
                    </li>
                </ul>
            </div>
        </div>
