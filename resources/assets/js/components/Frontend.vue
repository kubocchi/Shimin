                ...
                <div class="head_left">
                    <h1>
                        <a href="index.html" class="clearfix">
                            <p class="logo">
                                <img src="../../sass/themes/frontend/images/h1_logo.png" alt="宮崎市民活動センター">
                            </p>
                ...
                <ul class="banner">
                    <li>
                        <a href="http://www.city.miyazaki.miyazaki.jp/" target="_blank">
                            <img src="../../sass/themes/frontend/images/banner_mycity.png" alt="宮崎市">
                        </a>
                    </li>
                    <li>
                        <a href="http://www.my-shakyo.jp/" target="_blank">
                            <img src="../../sass/themes/frontend/images/banner_myshakyo.png" alt="宮崎市社会福祉協議会">
                        </a>
                    </li>
                    <li>
                        <a href="http://www.jnpoc.ne.jp/" target="_blank">
                            <img src="../../sass/themes/frontend/images/banner_jnpoc.png" alt="日本NPOセンター">
                        </a>
                    </li>
                    <li>
                        <a href="http://npo.pref.miyazaki.lg.jp/" target="_blank">
                            <img src="../../sass/themes/frontend/images/banner_mynpo.png" alt="宮崎県NPOポータルサイト">
                        </a>
                    </li>
                </ul>
            </div>
        ...
        <div id="footer">
            <div class="container">
                ...
                <div id="center_info" class="clearfix">
                    <div class="left">
                        <p class="logo">
                            <img src="../../sass/themes/frontend/images/logo_foot.png" alt="宮崎市民活動センター">
                        </p>
