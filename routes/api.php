...
Route::group(['middleware' => 'jwt.auth'], function ($router) {
    ...
    // Restore group-information as CSV
    Route::get('restore-file', 'GroupInformationController@restoreData');
    // Get Fileinfo
    Route::get('file-info', 'GroupInformationController@getFileInfo');
